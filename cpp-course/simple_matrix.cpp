...
{
	// No need for implementation, mat will create necessary storage
}
...
{
	if (this == &_rhs) return *this; // Handling self assignment
	mat = _rhs.get_mat();
	return *this;
}
...
SimpleMatrix<Type>::~SimpleMatrix() 
{
	...
	// there's no manual dynamic memory allocation
}
